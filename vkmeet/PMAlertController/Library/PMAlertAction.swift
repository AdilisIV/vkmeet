...
@objc open class PMAlertAction: UIButton {
    ...
    @objc public convenience init(title: String?, style: PMAlertActionStyle, action: (() -> Void)? = nil){
        ...
        style == .default ? (self.setTitleColor(UIColor(red: 62/255, green: 143/255, blue: 245/255, alpha: 1.0), for: UIControlState())) : (self.setTitleColor(UIColor.gray, for: UIControlState()))
