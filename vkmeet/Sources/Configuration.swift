...
//        configuration.weekDayTextColor = .black
        ...
        configuration.selectorColor = .clear // цвет полоски
        //configuration.backgroundColor = .white // цвет scrollableView
    ...
    public var selectedDayStyle: DayStyleConfiguration = {
        var configuration = DayStyleConfiguration()
        configuration.selectorColor = UIColor(red: 76.0/255.0, green: 163.0/255.0, blue: 248.0/255.0, alpha: 1.0) // цвет подчеркивания
        return configuration
    }()
